...
2. Make Apis using api.js file 
4. Edit `config.json` with your API details (e.g., stresser endpoints).
5. Run `go run c2.go`.
5. Connect: `telnet localhost 1111`.|
6. To convert GIF to TFX use gif.py  command -> python gif.py <input_gif_path> <output_tfx_path>
7. pip install numpy && pip install Pillow 
